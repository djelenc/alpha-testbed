...
public class ClassLoaderUtils {
     ...
     *
     * @param clazz       Interface of implementations to look for
     * @param classLoader The class loader to be used to load provider-configuration
     ...
     *
     * @param u  The URL of JAR to be added to class-path
     * @param cl The ClassLoader to be used for loading
     * @throws IOException
     */

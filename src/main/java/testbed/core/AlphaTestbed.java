...
public class AlphaTestbed {
     ...
     *
     * @param tm      Initialized instance of a trust model
     * @param scn     Initialized instance of a scenario
     * @param metrics Map of Metric instances and their initialization parameters.
     * @return Evaluation protocol instance or {@link IllegalArgumentException}
     * of no suitable protocol found.
     */
    public static EvaluationProtocol getProtocol(TrustModel<?> tm, Scenario scn,

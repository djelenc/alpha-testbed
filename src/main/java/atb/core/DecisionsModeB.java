 ...
 * <li>The atb instructs the trust model to generate opinion request (to
 * tell who to ask for opinions).
 * <li>The atb instructs the scenario to generate requested opinions.
 * <li>The atb conveys generated opinions to the trust model.
 * <li>The atb instructs the trust model to tell, with whom does it want to
 * interact.
 ...
 * <li>The atb instructs the trust model to estimate trust.
 ...
 * <li>The atb conveys the opinion requests to the opinion cost metric that

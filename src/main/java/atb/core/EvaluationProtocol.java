...
import static atb.core.AlphaTestbed.SCENARIOS;
import static atb.core.AlphaTestbed.TRUST_MODELS;
 ...
 * behavior that is specific for each evaluation protocol.
 * <p>
 ...
 * have to subscribe to the atb by using {@link #subscribe(MetricSubscriber)}
 * method. Second, at the end of each * evaluation step, the atb notifies all
 * subscribers by invoking their {@link MetricSubscriber#update(EvaluationProtocol)}
 * methods. Finally, the subscribers are expected to pull the results of the
 * evaluation via the {@link #getResult(int, Metric)} method.
 *
 * @author David
 */
public abstract class EvaluationProtocol {
     ...
     *
     * @param tm      Trust model insance
     * @param scn     Scenario instance
     * @param metrics Map of metrics, where keys represent metric classes and values
     *                their parameters.
     */
     ...
     *
     * @param tm      Trust model instance
     * @param scn     Scenario instance
     * @param metrics Map of metrics and their parameters
     ...
     * evaluation protocol.
     *
     * @param givenMetrics Set of given metrics.
     ...
     *
     * @param metricClass     Class of given metric.
     * @param requiredMetrics Set of required metric classes.
     * @return
     */
     ...
     *
     * @param observer The instance of the subscriber.
     */
     ...
     *
     * @param subscriber The instance to be removed.
     */

...
public class Utils {
     ...
     *
     * @param functor The functor object to perform semantical validation
     * @param index   The index of the desired parameter
     * @param params  The array of parameters
     * @return
     * @throws IllegalArgumentException If any errors occur during execution or when the passed in

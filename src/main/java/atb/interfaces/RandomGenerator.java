...
public interface RandomGenerator {
     ...
     */
    double nextDoubleFromTo(double min, double max);
     ...
     * @return random index
     */
    int nextIntFromTo(int min, int max);
     ...
     */
    <T> T fromWeights(TreeMap<T, Double> pmf);
     ...
     */
    <T extends Comparable<T>> Collection<T> chooseRandom(

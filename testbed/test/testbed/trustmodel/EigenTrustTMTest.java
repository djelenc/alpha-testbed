...
public class EigenTrustTMTest {
	...
	Assert.assertEquals(new Integer(2), tm.getTrustTotalOrder(0).get(0));
	Assert.assertEquals(new Integer(1), tm.getTrustTotalOrder(0).get(1));
	Assert.assertEquals(new Integer(3), tm.getTrustTotalOrder(0).get(2));
    }
}

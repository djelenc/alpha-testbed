...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
	...
	wizardModel.registerPanel(panel.getID(), panel);
    }
     ...
     * @param panel
     */
    public void updateWizardPanel(WizardPanelDescriptor panel) {
	...
	cardLayout.show(cardPanel, (id == null ? null : id.toString()));
	...
	if (classLoader == null)
	    throw new NullPointerException("Class loader not set.");

...
public class TransitiveWithChangesGUI extends JPanel implements
	IParametersPanel {
	...
	return new Object[] { getNumberOfAgents(), getSdExperiences(),
		...
		getChangeDensity(), getChangeInterval() };
    }
    ...
    private double getChangeDensity() {
